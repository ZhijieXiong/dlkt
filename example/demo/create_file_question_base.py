...
fpath = r"F:\code\myProjects\dlkt\lab\settings\random_split_leave_multi_out_setting\assist2009_test_split_0.txt"
data = read_preprocessed_file(fpath)

write2file(
    KTDataset.dataset_multi_concept2question_pykt(data, Q_table, 4, 200),
