...
if __name__ == "__main__":
    ...
    # 基本配置
    parser.add_argument("--save_model_dir", type=str, default=r"F:\code\myProjects\dlkt\lab\saved_models\2023-11-28-00-46-02@@AKT4cold_start@@seed_0@@random_split_leave_multi_out_setting@@assist2012_train_split_5@@valid_test@@early_stop_200_10@@265-53091-64-True-2-8-256-512-False-0.2@@10-20-0.7")
