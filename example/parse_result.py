...
if __name__ == "__main__":
    ...
    parser.add_argument("--file_path", type=str, default=r"F:\code\myProjects\dlkt\example\result_local\qdkt\save\our_setting_ood_by_school_SLP-phy_split_0_save.txt")
