...
if __name__ == "__main__":
    ...
    parser.add_argument("--file_path", type=str, default=r"F:\code\myProjects\dlkt\example\result_local\dkt_use_question\save\our_setting_edi2020-task34_save.txt")
