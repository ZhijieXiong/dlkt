...

{
  ...
  do
    ...
    python /ghome/xiongzj/code/dlkt/example/train/akt.py \
      ...
      --dim_model 512 --key_query_same True --num_head 8 --num_block 1 --dim_ff 512 --dim_final_fc 512 --dropout 0.1 \
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/akt_akt_setting_assist2009_save.txt