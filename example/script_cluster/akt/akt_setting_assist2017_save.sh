...

{
  ...
  do
    ...
    python /ghome/xiongzj/code/dlkt/example/train/akt.py \
      ...
      --dim_model 256 --key_query_same True --num_head 8 --num_block 2 --dim_ff 256 --dim_final_fc 512 --dropout 0.15 \
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/akt_akt_setting_assist2017_save.txt