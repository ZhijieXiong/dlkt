...

{
  ...
  do
    ...
    python /ghome/xiongzj/code/dlkt/example/train/akt.py \
      ...
      --enable_clip_grad True --grad_clipped 1 \
      --num_concept 27 --num_question 1223 \
      --dim_model 256 --key_query_same True --num_head 8 --num_block 1 --dim_ff 256 --dim_final_fc 512 --dropout 0.15 \
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/akt_akt_setting_statics2011_save.txt