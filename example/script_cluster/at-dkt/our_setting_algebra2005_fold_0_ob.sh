...

{
  ...
  weights_QT_loss='0.3 0.5 0.7 1'
  weights_IK_loss='0.1 0.3 0.5 0.7 1'
        ...
        do
          ...
          do
            ...
            python /ghome/xiongzj/code/dlkt/example/train/at_dkt.py \
              ...
              --QT_transformer_num_head 8 --IK_start 120 --weight_QT_loss "${weight_QT_loss}" --weight_IK_loss "${weight_IK_loss}" \
              --save_model False --debug_mode False --seed 0
        done
      done
    done
  done
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/at_dkt_our_setting_algebra2005_fold_0_ob.txt