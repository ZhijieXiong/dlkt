      ...
      do
        ...
        do
          ...
          do
            ...
            do
              echo -e "weight_decay: ${weight_decay}, dim_attention: ${dim_attention}, epsilon: ${epsilon}, beta: ${beta}, dropout: ${dropout}"
              python /ghome/xiongzj/code/dlkt/example/train/atkt.py \
                ...
                --dim_concept 64 --dim_correct 64 --dim_latent 256 --dim_attention "${dim_attention}" --dropout "${dropout}" --epsilon "${epsilon}" --beta "${beta}" \
