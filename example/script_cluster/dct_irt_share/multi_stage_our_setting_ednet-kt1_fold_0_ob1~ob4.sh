...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/dct_irt_share_multi_stage_our_setting_ednet-kt1_fold_0_ob1.txt
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/dct_irt_share_multi_stage_our_setting_ednet-kt1_fold_0_ob2.txt
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/dct_irt_share_multi_stage_our_setting_ednet-kt1_fold_0_ob3.txt
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/dct_irt_share_multi_stage_our_setting_ednet-kt1_fold_0_ob4.txt
