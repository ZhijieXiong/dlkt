...
ws_penalty_neg='0.0001 0.001 0.01 0.1 1'
ws_learning='0.0001 0.001 0.01 0.1 1'
ws_counter_fact='0.0001 0.001 0.01 0.1 1'
ws_q_able='0.0001 0.001 0.01 0.1 1'

{
  echo -e "DCT IRT share: add single aux penalty_neg loss"
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/dct_irt_share_single_stage_our_setting_statics2011_fold_0_ob1.txt

{
  echo -e "DCT IRT share: add single aux learn loss"
  for weight_decay in ${weight_decays}
  do
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/dct_irt_share_single_stage_our_setting_statics2011_fold_0_ob2.txt


{
  echo -e "DCT IRT share: add single aux counter_fact loss"
  for weight_decay in ${weight_decays}
  do
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/dct_irt_share_single_stage_our_setting_statics2011_fold_0_ob3.txt


{
  echo -e "DCT IRT share: add single aux q_table loss"
  for weight_decay in ${weight_decays}
  do
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/dct_irt_share_single_stage_our_setting_statics2011_fold_0_ob4.txt
