...
ws_penalty_neg='0.01 0.1'
ws_learning='0.01 0.1'
        ...
        do
          ...
          do
            ...
            python /ghome/xiongzj/code/dlkt/example/train/dct.py \
              ...
              --w_penalty_neg "${w_penalty_neg}" --w_learning "${w_learning}" --w_counter_fact 0 --w_q_table "${w_q_able}" \
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/dct_new_irt_not_share_single_stage_our_setting_assist2009_fold_0_ob5.txt
