...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/dct_new_irt_not_share_single_stage_our_setting_statics2011_fold_0_ob1.txt
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/dct_new_irt_not_share_single_stage_our_setting_statics2011_fold_0_ob2.txt
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/dct_new_irt_not_share_single_stage_our_setting_statics2011_fold_0_ob3.txt
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/dct_new_irt_not_share_single_stage_our_setting_statics2011_fold_0_ob4.txt
