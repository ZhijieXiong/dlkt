  ...
  do
      ...
      do
        ...
        python /ghome/xiongzj/code/dlkt/example/train/dimkt.py \
          ...
          --num_concept 265 --num_question 53091 --num_min_question 30 --num_min_concept 30 \
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/dimkt_dimkt_setting_assist2012_fold_0_ob.txt