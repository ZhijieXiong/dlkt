      ...
      do
        ...
        do
          ...
          python /ghome/xiongzj/code/dlkt/example/train/dkvmn.py \
            ...
            --use_concept False --num_concept 101 --num_question 2803 --dim_key "${dim_key}" --dim_value "${dim_value}" --dropout "${dropout}" \
            --save_model False --debug_mode False --use_cpu False --seed 0
        done
      done
    done
  done
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/dkvmn_que_our_setting_assist2017_fold_0_ob.txt
