        ...
        do
          ...
          do
            ...
            do
              ...
              python /ghome/xiongzj/code/dlkt/example/train/lpkt_max_entropy_aug.py \
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/lpkt_ME-ADA_our_setting_assist2017_fold_0_ob2.txt