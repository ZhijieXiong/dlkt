  ...
  do
    ...
    do
      ...
      do
        ...
        do
          echo -e "warm up: 1, lr: 0.001, no lr decay, weight_decay: ${weight_decay}, temp: ${temp}, num_cluster: ${num_cluster}, weight_cl: ${weight_cl}"
          python /ghome/xiongzj/code/dlkt/example/train/qdkt_cluster_cl.py \
            ...
            --use_warm_up4cl True --epoch_warm_up4cl 1 --latent_type4cl "last_time" \
            ...
            --aug_order "['mask', 'replace', 'permute']" --offline_sim_type "RCD_graph" \
          ...
          echo -e "lr: 0.001, no lr decay, weight_decay: ${weight_decay}, temp: ${temp}, num_cluster: ${num_cluster}, weight_cl: ${weight_cl}"
          python /ghome/xiongzj/code/dlkt/example/train/qdkt_cluster_cl.py \
            --setting_name "our_setting" --dataset_name "${dataset_name}" --data_type "${data_type}" \
            --train_file_name "${dataset_name}_train_fold_${fold}.txt" --valid_file_name "${dataset_name}_valid_fold_${fold}.txt" --test_file_name "${dataset_name}_test_fold_${fold}.txt" \
            --optimizer_type "adam" --weight_decay "${weight_decay}" --momentum 0.9 \
...
#          echo -e "lr: 0.001, lr decay: MultiStepLR [5] 0.5, weight_decay: ${weight_decay}, temp: ${temp}, num_cluster: ${num_cluster}, weight_cl: ${weight_cl}"
#          python /ghome/xiongzj/code/dlkt/example/train/qdkt_cluster_cl.py \
#            --setting_name "our_setting" --dataset_name "${dataset_name}" --data_type "${data_type}" \
#            --train_file_name "${dataset_name}_train_fold_${fold}.txt" --valid_file_name "${dataset_name}_valid_fold_${fold}.txt" --test_file_name "${dataset_name}_test_fold_${fold}.txt" \
#            --optimizer_type "adam" --weight_decay "${weight_decay}" --momentum 0.9 \
...
#            --use_last_average False --epoch_last_average 5 \
#            --main_metric "AUC" --use_multi_metrics False \
#            --learning_rate 0.001 --enable_lr_schedule True --lr_schedule_type "MultiStepLR" --lr_schedule_step 10 --lr_schedule_milestones "[5]" --lr_schedule_gamma 0.5 \
#            --train_batch_size 64 --evaluate_batch_size 256 \
#            --enable_clip_grad False --grad_clipped 10.0 \
#            --num_concept 493 --num_question 129263 \
#            --dim_concept 64 --dim_question 64 --dim_correct 64 --dim_latent 64 --rnn_type "gru" --num_rnn_layer 1 --dropout 0.4 --num_predict_layer 3 --dim_predict_mid 128 --activate_type "relu" \
...
#
#
#          echo -e "lr: 0.002, lr decay: MultiStepLR [5] 0.5, weight_decay: ${weight_decay}, temp: ${temp}, num_cluster: ${num_cluster}, weight_cl: ${weight_cl}"
#          python /ghome/xiongzj/code/dlkt/example/train/qdkt_cluster_cl.py \
#            --setting_name "our_setting" --dataset_name "${dataset_name}" --data_type "${data_type}" \
#            --train_file_name "${dataset_name}_train_fold_${fold}.txt" --valid_file_name "${dataset_name}_valid_fold_${fold}.txt" --test_file_name "${dataset_name}_test_fold_${fold}.txt" \
#            --optimizer_type "adam" --weight_decay "${weight_decay}" --momentum 0.9 \
...
#
#
#          echo -e "lr: 0.002, lr decay: MultiStepLR [5, 10] 0.5, weight_decay: ${weight_decay}, temp: ${temp}, num_cluster: ${num_cluster}, weight_cl: ${weight_cl}"
#          python /ghome/xiongzj/code/dlkt/example/train/qdkt_cluster_cl.py \
#            --setting_name "our_setting" --dataset_name "${dataset_name}" --data_type "${data_type}" \
#            --train_file_name "${dataset_name}_train_fold_${fold}.txt" --valid_file_name "${dataset_name}_valid_fold_${fold}.txt" --test_file_name "${dataset_name}_test_fold_${fold}.txt" \
#            --optimizer_type "adam" --weight_decay "${weight_decay}" --momentum 0.9 \
...
#            --use_last_average False --epoch_last_average 5 \
#            --main_metric "AUC" --use_multi_metrics False \
#            --learning_rate 0.002 --enable_lr_schedule True --lr_schedule_type "MultiStepLR" --lr_schedule_step 10 --lr_schedule_milestones "[5, 10]" --lr_schedule_gamma 0.5 \
#            --train_batch_size 64 --evaluate_batch_size 256 \
#            --enable_clip_grad False --grad_clipped 10.0 \
#            --num_concept 493 --num_question 129263 \
#            --dim_concept 64 --dim_question 64 --dim_correct 64 --dim_latent 64 --rnn_type "gru" --num_rnn_layer 1 --dropout 0.4 --num_predict_layer 3 --dim_predict_mid 128 --activate_type "relu" \
...
#} >> /ghome/xiongzj/code/dlkt/example/result_cluster/qdkt_cluster_cl_random_aug_random_seq_len_our_setting_bridge2algebra2006_fold_0_ob.txt
