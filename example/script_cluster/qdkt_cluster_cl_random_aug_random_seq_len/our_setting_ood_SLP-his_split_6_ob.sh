        ...
        do
          ...
          do
            ...
            python /ghome/xiongzj/code/dlkt/example/train/qdkt_cluster_cl.py \
              ...
              --use_warm_up4cl True --epoch_warm_up4cl 2 \
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/qdkt_cluster_cl_random_aug_random_seq_len_our_setting_ood_SLP-his_split_6_ob.txt
