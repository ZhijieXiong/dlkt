        ...
        do
          ...
          do
            ...
            python /ghome/xiongzj/code/dlkt/example/train/qdkt_cluster_cl.py \
              ...
              --dim_concept 64 --dim_question 64 --dim_correct 128 --dim_latent 64 --rnn_type "gru" --num_rnn_layer 1 --dropout "${dropout}" \
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/qdkt_cluster_cl_random_aug_random_seq_len_our_setting_ood_assist2012_split_7_ob.txt
