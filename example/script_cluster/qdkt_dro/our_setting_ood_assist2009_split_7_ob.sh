  ...
  do
    ...
    do
      ...
      do
        ...
        python /ghome/xiongzj/code/dlkt/example/train/qdkt_dro.py \
          ...
          --learning_rate 0.0005 --enable_lr_schedule False --lr_schedule_type "MultiStepLR" --lr_schedule_step 10 --lr_schedule_milestones "[5]" --lr_schedule_gamma 0.5 \
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/qdkt_dro_our_setting_ood_assist2009_split_7_ob1.txt
