...

{
  ...
  do
    ...
    python /ghome/xiongzj/code/dlkt/example/train/qdkt_instance_cl.py \
      ...
      --cl_space latent --temp 0.05 --weight_cl_loss "${weight_cl}" --latent_type4cl "last_time" \
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/qdkt_instance_cl_info_aug_all_time_our_setting_assist2009_fold_0_ob.txt
