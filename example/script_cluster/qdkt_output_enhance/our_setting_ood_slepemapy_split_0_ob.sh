      ...
      do
        ...
        do
          ...
          python /ghome/xiongzj/code/dlkt/example/train/qdkt_output_enhance.py \
            ...
            --enhance_method 0 \
            --weight_enhance_loss1 "${weight_enhance_loss1}" --num_min_question4diff 15 --hard_acc 0.6 --easy_acc 0.9 \
...
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/qdkt_output_enhance_our_setting_slepemapy_split_0_ob.txt