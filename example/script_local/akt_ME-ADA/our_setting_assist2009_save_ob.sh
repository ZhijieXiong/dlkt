...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/akt_max_entropy_aug.py \
      ...
      --separate_qa False --seq_representation "encoder_output" --weight_rasch_loss 0.00001 \
      --use_warm_up True --epoch_warm_up 1 \
      --epoch_interval_generate 2 --epoch_generate 200 --weight_adv_pred_loss 0.5 --loop_adv 3 --adv_learning_rate 1 --eta 20 --gamma 20 \
      --save_model False --debug_mode False --seed 0
  done
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/akt_max_entropy_aug.py \
      ...
      --separate_qa False --seq_representation "encoder_output" --weight_rasch_loss 0.00001 \
      --use_warm_up True --epoch_warm_up 1 \
      --epoch_interval_generate 3 --epoch_generate 200 --weight_adv_pred_loss 0.5 --loop_adv 3 --adv_learning_rate 1 --eta 20 --gamma 20 \
      --save_model False --debug_mode False --seed 0
  done
