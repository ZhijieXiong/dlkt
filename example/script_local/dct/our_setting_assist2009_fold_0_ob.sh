          ...
          do
            ...
            do
              ...
              python F:/code/myProjects/dlkt/example/train/dct.py \
                ...
                --dim_question "${dim_question}" --dim_correct 50 --dim_latent "${dim_latent}" --rnn_type "gru" --num_rnn_layer "${num_rnn_layer}" --dropout "${dropout}" \
...
} >> F:/code/myProjects/dlkt/example/result_local/dct_our_setting_assist2009_fold_0_ob.txt