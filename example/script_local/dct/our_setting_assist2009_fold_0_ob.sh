...
} >> F:/code/myProjects/dlkt/example/result_local/dct+aux_loss_our_setting_assist2009_fold_0_ob1.txt
...
} >> F:/code/myProjects/dlkt/example/result_local/dct+aux_loss_our_setting_assist2009_fold_0_ob2.txt