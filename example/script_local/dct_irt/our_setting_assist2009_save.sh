...
#      --dim_question 32 --dim_correct 64 --dim_latent 32 --rnn_type "gru" --num_rnn_layer 2 --dropout 0.1 \
...
} >> F:/code/myProjects/dlkt/example/result_local/dct_baseline_our_setting_assist2009_save.txt