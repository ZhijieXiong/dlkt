...
#    done
#  done
#} >> F:/code/myProjects/dlkt/example/result_local/dct_baseline_our_setting_ednet-kt1_fold_0_ob.txt



{
  # weight_decay为0.0001下最佳模型结果加辅助损失：num_rnn_layer: 2, dim_question: 64, dim_latent: 64, dropout: 0.05
  dropouts='0.05'
...
} >> F:/code/myProjects/dlkt/example/result_local/dct-penalty_neg-learn-q_table-our_setting_ednet-kt1_fold_0_ob1.txt