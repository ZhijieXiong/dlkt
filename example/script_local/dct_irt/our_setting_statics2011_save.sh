...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/dct.py \
      ...
      --dim_question 32 --dim_correct 64 --dim_latent 20 --rnn_type "gru" --num_rnn_layer 2 --dropout 0.05 \
...
} >> F:/code/myProjects/dlkt/example/result_local/dct_baseline_our_setting_statics2011_save.txt