...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/dct.py \
      ...
      --dim_question 32 --dim_correct 64 --dim_latent 32 --rnn_type "gru" --num_rnn_layer 2 --dropout 0.1 --que_user_share_proj False \
...
} >> F:/code/myProjects/dlkt/example/result_local/dct_irt_not_share_baseline_our_setting_assist2009_save.txt
