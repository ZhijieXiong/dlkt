...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/dct.py \
      ...
      --dim_question 96 --dim_correct 64 --dim_latent 64 --rnn_type "gru" --num_rnn_layer 1 --dropout 0.15 --que_user_share_proj False \
...
} >> F:/code/myProjects/dlkt/example/result_local/dct_irt_not_share_baseline_our_setting_assist2017_save.txt