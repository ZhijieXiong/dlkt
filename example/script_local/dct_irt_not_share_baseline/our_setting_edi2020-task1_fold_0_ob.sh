        ...
        do
          ...
          do
            ...
            python F:/code/myProjects/dlkt/example/train/dct.py \
              ...
              --dim_question "${dim_question}" --dim_correct "${dim_latent}" --dim_latent "${dim_question}" --rnn_type "gru" \
...
} >> F:/code/myProjects/dlkt/example/result_local/dct_irt_not_share_baseline_our_setting_edi2020-task1_fold_0_ob.txt