...
{
  # weight_decay: 0.001, num_rnn_layer: 3, dim_question: 64, dropout: 0.3
  for fold in "${folds[@]}"
  do
    echo -e "fold: ${fold}"
    python F:/code/myProjects/dlkt/example/train/dct.py \
      ...
      --dim_question 64 --dim_correct 64 --dim_latent 64 --rnn_type "gru" --num_rnn_layer 3 --dropout 0.3 --que_user_share_proj True \
...
} >> F:/code/myProjects/dlkt/example/result_local/dct_irt_share_baseline_our_setting_assist2009_save.txt
