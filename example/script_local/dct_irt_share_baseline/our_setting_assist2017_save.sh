...
{
  # weight_decay: 0.00001, num_rnn_layer: 2, dim_question: 96, dropout: 0.2
  for fold in "${folds[@]}"
  do
    echo -e "fold: ${fold}"
    python F:/code/myProjects/dlkt/example/train/dct.py \
      ...
      --dim_question 96 --dim_correct 96 --dim_latent 96 --rnn_type "gru" --num_rnn_layer 2 --dropout 0.2 --que_user_share_proj True \
...
} >> F:/code/myProjects/dlkt/example/result_local/dct_irt_share_baseline_our_setting_assist2017_save.txt