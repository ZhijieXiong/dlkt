...
{
  # weight_decay: 0.00001, num_rnn_layer: 2, dim_question: 64, dropout: 0.2
  for fold in "${folds[@]}"
  do
    echo -e "fold: ${fold}"
    python F:/code/myProjects/dlkt/example/train/dct.py \
      ...
      --dim_question 64 --dim_correct 64 --dim_latent 64 --rnn_type "gru" --num_rnn_layer 2 --dropout 0.2 --que_user_share_proj True \
