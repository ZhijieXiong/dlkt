...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/dct.py \
      ...
      --dim_question 64 --dim_correct 64 --dim_latent 64 --rnn_type "gru" --num_rnn_layer 1 --dropout 0.1 --que_user_share_proj True \
...
} >> F:/code/myProjects/dlkt/example/result_local/dct_irt_share_baseline_our_setting_edi2020-task34_save.txt