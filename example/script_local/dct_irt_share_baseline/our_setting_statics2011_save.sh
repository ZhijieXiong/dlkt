...
{
  # weight_decay: 0.0001, num_rnn_layer: 3, dim_question: 20, dropout: 0.1
  for fold in "${folds[@]}"
  do
    echo -e "fold: ${fold}"
    python F:/code/myProjects/dlkt/example/train/dct.py \
      ...
      --dim_question 20 --dim_correct 20 --dim_latent 20 --rnn_type "gru" --num_rnn_layer 3 --dropout 0.1 --que_user_share_proj True \
