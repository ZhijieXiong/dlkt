...
} >> F:/code/myProjects/dlkt/example/result_local/dct_rasch_baseline_our_setting_assist2017_fold_0_ob.txt



#{
#  # weight_decay为0.0001下最佳模型结果加辅助损失：num_rnn_layer: 1, dim_question: 96, dim_latent: 64, dropout: 0.15
#  dropouts='0.15'
...
#    done
#  done
#} >> F:/code/myProjects/dlkt/example/result_local/dct-penalty_neg-learn-q_table-our_setting_assist2017_fold_0_ob1.txt