...

{
  ...
  do
    for num_min_question in 50 100 150
    do
      ...
      do
        ...
        python F:/code/myProjects/dlkt/example/train/dimkt.py \
          ...
          --num_min_question "${num_min_question}" --num_min_concept 30 --num_concept 27 --num_question 1223 \
        ...
        rm F:/code/myProjects/dlkt/lab/settings/our_setting/statics2011_train_fold_0_dimkt_diff.json

      done
    done
  done

} >> F:/code/myProjects/dlkt/example/result_local/dimkt_our_setting_statics2011_fold_0_ob.txt