      ...
      do
        ...
        do
          ...
          python F:/code/myProjects/dlkt/example/train/dkvmn.py \
            ...
            --use_concept True --num_concept 265 --num_question 53091 --dim_key "${dim_key}" --dim_value "${dim_value}" --dropout "${dropout}" \
            --save_model False --seed 0
        done
      done
    done
  done
} >> F:/code/myProjects/dlkt/example/result_local/dkvmn_our_setting_assist2012_fold_0_ob.txt