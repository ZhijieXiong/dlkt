      ...
      do
        ...
        do
          ...
          python F:/code/myProjects/dlkt/example/train/dkvmn.py \
            ...
            --use_concept True --num_concept 27 --num_question 1223 --dim_key "${dim_key}" --dim_value "${dim_value}" --dropout "${dropout}" \
            --save_model False --seed 0
        done
      done
    done
  done
} >> F:/code/myProjects/dlkt/example/result_local/dkvmn_our_setting_statics2011_fold_0_ob.txt