...
{
  # weight_decay: 0.0001, dim: 64, dropout: 0.05
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/lpkt_plus.py \
      ...
      --dim_question 64 --dim_latent 64 --dim_correct 50 --dropout 0.05 --que_user_share_proj False \
...
} >> F:/code/myProjects/dlkt/example/result_local/lpkt+_irt_not_share_baseline_our_setting_assist2017_save.txt