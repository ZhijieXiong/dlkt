...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/lpkt_plus.py \
      ...
      --dim_question 256 --dim_latent 256 --dim_correct 50 --dropout 0.1 --que_user_share_proj False \
...
} >> F:/code/myProjects/dlkt/example/result_local/lpkt+_irt_not_share_baseline_our_setting_xes3g5m_save_ob.txt