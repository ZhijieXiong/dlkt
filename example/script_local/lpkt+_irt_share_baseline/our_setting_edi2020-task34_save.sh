...

{
  ...
  # weight_decay: 0.00001, dim: 48, dropout: 0.1
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/lpkt_plus.py \
      ...
      --dim_question 48 --dim_latent 48 --dim_correct 48 --dropout 0.1 --que_user_share_proj True \
...
} >> F:/code/myProjects/dlkt/example/result_local/lpkt+_irt_share_baseline_our_setting_edi2020-task34_save_ob.txt