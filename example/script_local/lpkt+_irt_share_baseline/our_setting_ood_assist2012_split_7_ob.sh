    ...
    do
      ...
      do
        ...
        python F:/code/myProjects/dlkt/example/train/lpkt_plus.py \
          ...
          --dim_question "${dim}" --dim_latent "${dim}" --dim_correct "${dim}" --dropout "${dropout}" --que_user_share_proj True \
...
} >> F:/code/myProjects/dlkt/example/result_local/lpkt+_irt_share_baseline_our_setting_ood_assist2012_split_7_ob.txt