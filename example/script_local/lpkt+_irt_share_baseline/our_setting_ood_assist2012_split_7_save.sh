...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/lpkt_plus.py \
      ...
      --dim_e 128 --dim_latent 128 --dim_correct 50 --dropout 0.1 --que_user_share_proj True \
...
} >> F:/code/myProjects/dlkt/example/result_local/lpkt+_irt_share_baseline_our_setting_ood_assist2012_split_7_save_ob.txt