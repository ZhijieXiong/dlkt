...
{
  # weight_decay: 0.00001, dim: 32, dropout: 0.2
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/lpkt_plus.py \
      ...
      --dim_question 32 --dim_latent 32 --dim_correct 32 --dropout 0.2 --que_user_share_proj True \
...
} >> F:/code/myProjects/dlkt/example/result_local/lpkt+_irt_share_baseline_our_setting_statics2011_save.txt