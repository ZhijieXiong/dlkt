    ...
    do
      ...
      do
        ...
        python F:/code/myProjects/dlkt/example/train/lpkt_plus.py \
          ...
          --num_concept 53 --num_question 948 --model_version 3 --ablation_set 1 \
...
} >> F:/code/myProjects/dlkt/example/result_local/lpkt_plus_v2_our_setting_edi2020-task34_fold_0_ob.txt