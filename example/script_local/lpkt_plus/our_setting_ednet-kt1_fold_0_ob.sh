...
#} >> F:/code/myProjects/dlkt/example/result_local/lpkt+_baseline_our_setting_ednet-kt1_fold_0_ob.txt
...
#    done
#  done
#} >> F:/code/myProjects/dlkt/example/result_local/lpkt+_our_setting_ednet-kt1_fold_0_ob.txt