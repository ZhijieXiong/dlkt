    ...
    do
      ...
      do
        ...
        python F:/code/myProjects/dlkt/example/train/lpkt_plus.py \
          ...
          --num_concept 188 --num_question 11858 --ablation_set 0 --model_version 3 \
...
} >> F:/code/myProjects/dlkt/example/result_local/lpkt_plus_v2_our_setting_ednet-kt1_fold_0_ob.txt