...

{
  ...
  # 第1阶段粗调
  # weight_decay: 0.0001, weight_aux_emb: 0.5, dim_question: 64, dim_latent: 128, num_rnn_layer: 2, num_mlp_layer: 2, dropout: 0.1
#  dropouts='0.1'
...
} >> F:/code/myProjects/dlkt/example/result_local/aux-info-dct_not-share_our_setting_new_assist2009_fold_0_ob2.txt