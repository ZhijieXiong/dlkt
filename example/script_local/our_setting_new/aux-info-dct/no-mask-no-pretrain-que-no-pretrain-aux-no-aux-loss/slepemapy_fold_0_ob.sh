...

{
  ...
  # 1阶段
  # weight_decay: 0, weight_aux_emb: 0.5, dim_question: 64, dim_latent: 128, num_rnn_layer: 3, num_mlp_layer: 2, dropout: 0.1
#  dropouts='0.1'
...
} >> F:/code/myProjects/dlkt/example/result_local/aux-info-dct_not-share_our_setting_new_slepemapy_fold_0_ob2.txt