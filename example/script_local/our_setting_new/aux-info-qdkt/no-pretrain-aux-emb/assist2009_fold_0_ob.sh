...

{
  ...
  # 第1阶段粗调
  # weight_decay: 0.000001, weight_aux_emb: 0.3, dim_question: 64, dim_latent: 128, num_predict_layer: 2, dropout: 0.1
  # dim_question: 64, dim_latent: 128, rnn_type: gru, num_rnn_layer: 1, dropout: 0.1,  num_predict_layer: 2, dim_predict_mid: 128, activate_type: relu, weight_aux_emb: 0.3
#  dropouts='0.1'
...
} >> F:/code/myProjects/dlkt/example/result_local/aux-info-qdkt_our_setting_new_assist2009_fold_0_ob2.txt