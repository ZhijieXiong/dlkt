...

{
  ...
  # 1阶段
  # weight_decay: 0.00001, weight_aux_emb: 0.5, dim_question: 64, dim_latent: 128, num_rnn_layer: 3, num_predict_layer: 2, dropout: 0.1
#  dropouts='0.1'
...
} >> F:/code/myProjects/dlkt/example/result_local/aux-info-qdkt_our_setting_new_assist2012_fold_0_ob2.txt