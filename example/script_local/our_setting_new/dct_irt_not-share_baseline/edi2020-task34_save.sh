...
{
  # weight_decay: 0.000001, num_rnn_layer: 3, dim_question: 96, dim_latent: 96, num_mlp_layer: 2, dropout: 0.1
  for fold in "${folds[@]}"
  do
    echo -e "fold: ${fold}"
...
} >> F:/code/myProjects/dlkt/example/result_local/dct_irt_not_share_baseline_our_setting_new_edi2020-task34_save.txt