...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/dimkt.py \
      ...
      --num_min_question 50 --num_min_concept 30 --num_concept 27 --num_question 1223 \
...
} >> F:/code/myProjects/dlkt/example/result_local/dimkt_our_setting_new_statics2011_save.txt