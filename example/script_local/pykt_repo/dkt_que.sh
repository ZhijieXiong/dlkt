...
} >> F:/code/myProjects/dlkt/example/result_local/dkt_que_pykt_question_setting_edi2020-task34_save.txt
...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/dkt.py \
      ...
      --dim_emb 64 --dim_latent 64 --rnn_type "gru" --num_rnn_layer 1 --dropout 0.3 --num_predict_layer 2 --dim_predict_mid 256 --activate_type "sigmoid" \
      --save_model True --debug_mode False --use_cpu False --seed 0
  done

} >> F:/code/myProjects/dlkt/example/result_local/dkt_que_pykt_question_setting_statics2011_save.txt