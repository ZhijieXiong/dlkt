...

{
  ...
  do
    echo -e "weight_decay: 0.001, dim_correct: 128, dim_latent: 128, dropout: ${dropout}"
    python F:/code/myProjects/dlkt/example/train/qdkt.py \
      ...
      --dim_concept 64 --dim_question 64 --dim_correct 128 --dim_latent 128 --rnn_type gru --num_rnn_layer 1 --dropout "${dropout}" --num_predict_layer 3 --dim_predict_mid 128 --activate_type relu \
...
} >> F:/code/myProjects/dlkt/example/result_local/qdkt_our_setting_ood_by_school_assist2012_split_1_ob.txt