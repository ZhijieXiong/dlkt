...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/qdkt.py \
      ...
      --train_file_name "${dataset_name}_train_split_${split}.txt" --valid_file_name "${dataset_name}_valid_split_${split}.txt" --test_file_name "${dataset_name}_test_split_${split}.txt" \
