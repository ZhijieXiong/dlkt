...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/qdkt_max_entropy_aug.py \
      ...
      --epoch_interval_generate 1 --epoch_generate 200 --weight_adv_pred_loss 0.8 --loop_adv 3 --adv_learning_rate 5 --eta 5 --gamma 5 \
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/qdkt_max_entropy_aug.py \
      ...
      --dim_concept 64 --dim_question 64 --dim_correct 64 --dim_latent 128 --rnn_type "gru" --num_rnn_layer 1 --dropout 0.3 --num_predict_layer 3 --dim_predict_mid 128 --activate_type "relu" \
      --use_warm_up False --epoch_warm_up 4 \
      --epoch_interval_generate 1 --epoch_generate 200 --weight_adv_pred_loss 1 --loop_adv 3 --adv_learning_rate 5 --eta 5 --gamma 5 \
      --save_model True --seed 0
  done
...
#  done
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/qdkt_max_entropy_aug.py \
      ...
      --dim_concept 64 --dim_question 64 --dim_correct 64 --dim_latent 128 --rnn_type "gru" --num_rnn_layer 1 --dropout 0.3 --num_predict_layer 3 --dim_predict_mid 128 --activate_type "relu" \
      --use_warm_up False --epoch_warm_up 4 \
      --epoch_interval_generate 1 --epoch_generate 200 --weight_adv_pred_loss 1.5 --loop_adv 3 --adv_learning_rate 5 --eta 5 --gamma 5 \
      --save_model True --seed 0
  done
