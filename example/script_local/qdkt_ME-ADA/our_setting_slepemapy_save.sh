...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/qdkt_max_entropy_aug.py \
      ...
      --epoch_interval_generate 1 --epoch_generate 200 --weight_adv_pred_loss 0.5 --loop_adv 3 --adv_learning_rate 10 --eta 10 --gamma 5 \
      --save_model True --debug_mode False --use_cpu False --seed 0
  done

} >> F:/code/myProjects/dlkt/example/result_local/qdkt_ME-ADA_our_setting_slepemapy_save.txt