...

{
  ...
  do
    ...
    do
      ...
      do
        echo -e "dropout: ${dropout}, weight_adv: ${weight_adv}, fold: ${fold}"
...
} >> F:/code/myProjects/dlkt/example/result_local/qdkt_ME-ADA_our_setting_statics2011_save_ob.txt