...
#  weights_decay='0 0.001 0.000001'
#  dropouts='0.1 0.2 0.3'
#  weights_adv='1 0.8 1.2'
#  for weight_decay in ${weights_decay}
#  do
#    for dropout in ${dropouts}
#    do
#      for weight_adv in ${weights_adv}
#      do
#        for fold in 0 1 2 3 4
#        do
#          echo -e "weight_decay: ${weight_decay}, dropout: ${dropout}, weight_adv: ${weight_adv}, fold: ${fold}"
...
#            --epoch_interval_generate 1 --epoch_generate 200 --weight_adv_pred_loss "${weight_adv}" --loop_adv 3 --adv_learning_rate 5 --eta 5 --gamma 20 \
...
#  done
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/qdkt_max_entropy_aug.py \
      ...
      --use_warm_up False --epoch_warm_up 4 \
      --epoch_interval_generate 1 --epoch_generate 200 --weight_adv_pred_loss 1.2 --loop_adv 3 --adv_learning_rate 5 --eta 5 --gamma 20 \
      --save_model True --seed 0
  done

} >> F:/code/myProjects/dlkt/example/result_local/qdkt_ME-ADA_our_setting_statics2011_save.txt