...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/qdkt_max_entropy_aug.py \
      --setting_name "our_setting_ood_by_school" --dataset_name "${dataset_name}" --data_type "${data_type}" \
...
} >> F:/code/myProjects/dlkt/example/result_local/qdkt_ME-ADA_our_setting_ood_by_school_assist2009_save.txt