...
#  insert_probs='0.1 0.3'
#  mask_probs='0.1 0.3'
#  replace_probs='0.1 0.3'
#  for insert_prob in ${insert_probs}
#  do
#    for mask_prob in ${mask_probs}
#    do
#      for replace_prob in ${replace_probs}
#      do
#        echo -e "insert_prob: ${insert_prob}, mask_prob: ${mask_prob}, replace_prob: ${replace_prob}"
#        python F:/code/myProjects/dlkt/example/train/qdkt_cluster_cl.py \
#          --setting_name "our_setting" --dataset_name "${dataset_name}" --data_type "${data_type}" \
#          --train_file_name "${dataset_name}_train_fold_${fold}.txt" --valid_file_name "${dataset_name}_valid_fold_${fold}.txt" --test_file_name "${dataset_name}_test_fold_${fold}.txt" \
#          --optimizer_type "adam" --weight_decay 0.0001 --momentum 0.9 \
...
#          --dim_concept 64 --dim_question 64 --dim_correct 64 --dim_latent 64 --rnn_type "gru" --num_rnn_layer 1 --dropout 0.3 --num_predict_layer 3 --dim_predict_mid 128 --activate_type "relu" \
#          --use_warm_up4cl True --epoch_warm_up4cl 4 --cl_type "last_time" \
#          --num_cluster 64 --temp 0.05 --weight_cl_loss 0.0001 \
#          --use_online_sim True --use_warm_up4online_sim True --epoch_warm_up4online_sim 4 \
#          --aug_type "informative_aug" --use_random_select_aug_len True \
...
} >> F:/code/myProjects/dlkt/example/result_local/qdkt_cluster_cl_random_aug_random_seq_len_our_setting_assist2017_fold_0_ob.txt
