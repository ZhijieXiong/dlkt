...
bash F:/code/myProjects/dlkt/example/script_local/our_setting_new/aux-info-dct/assist2009_fold_0_ob.sh
bash F:/code/myProjects/dlkt/example/script_local/our_setting_new/aux-info-dct/assist2017_fold_0_ob.sh
bash F:/code/myProjects/dlkt/example/script_local/our_setting_new/aux-info-dct/edi2020-task34_fold_0_ob.sh
bash F:/code/myProjects/dlkt/example/script_local/our_setting_new/aux-info-dct/ednet-kt1_fold_0_ob.sh
