...
} >> F:/code/myProjects/dlkt/example/result_local/dct_new_irt_not_share_baseline_our_setting_assist2017_fold_0_ob.txt
...
} >> F:/code/myProjects/dlkt/example/result_local/dct_new_irt_share_baseline_our_setting_assist2017_fold_0_ob.txt
