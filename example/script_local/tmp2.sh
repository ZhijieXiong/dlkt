        ...
        do
          ...
          do
            ...
            do
              ...
              do
                echo -e "weight_decay: ${weight_decay}, num_rnn_layer: ${num_rnn_layer}, dim_question: ${dim_question}, dim_latent: ${dim_latent}, num_mlp_layer: ${num_mlp_layer}, dropout: ${dropout}"
...
} >> F:/code/myProjects/dlkt/example/result_local/dct_new_irt_not_share_baseline_our_setting_edi2020-task1_fold_0_ob.txt
      ...
      for dim_question in "${dims_question[@]}"
        do
          ...
          do
            for dropout in ${dropouts}
            do
              echo -e "weight_decay: ${weight_decay}, num_rnn_layer: ${num_rnn_layer}, dim_question: ${dim_question}, num_mlp_layer: ${num_mlp_layer}, dropout: ${dropout}"
              python F:/code/myProjects/dlkt/example/train/dct.py \
                --setting_name "our_setting" --dataset_name "${dataset_name}" --data_type "${data_type}" \
                --train_file_name "${dataset_name}_train_fold_${fold}.txt" --valid_file_name "${dataset_name}_valid_fold_${fold}.txt" --test_file_name "${dataset_name}_test_fold_${fold}.txt" \
                --optimizer_type "adam" --weight_decay "${weight_decay}" --momentum 0.9 \
...
} >> F:/code/myProjects/dlkt/example/result_local/dct_new_irt_share_baseline_our_setting_edi2020-task1_fold_0_ob.txt
