      ...
      do
        ...
        do
          ...
          CUDA_VISIBLE_DEVICES=1 python /home/xiongzj/myProjects/KT/dlkt/example/train/akt.py \
            ...
            --learning_rate 0.0002 --enable_lr_schedule True --lr_schedule_type "MultiStepLR" --lr_schedule_step 10 --lr_schedule_milestones "[5]" --lr_schedule_gamma 0.5 \
...
} >> /home/xiongzj/myProjects/KT/dlkt/example/results/akt_our_setting_algebra2005_fold_0_ob.txt