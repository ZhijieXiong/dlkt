  ...
  do
    ...
    do
      ...
      do
        ...
        CUDA_VISIBLE_DEVICES=7 python /home/xiongzj/myProjects/KT/dlkt/example/train/lpkt.py \
...
#} >> /home/xiongzj/myProjects/KT/dlkt/example/results/lpkt_our_setting_bridge2algebra2006_fold_0_ob.txt