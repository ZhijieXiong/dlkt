...

{
  ...
  do
    echo -e "fold: ${fold}"
    CUDA_VISIBLE_DEVICES=4 python /home/xiongzj/myProjects/KT/dlkt/example/train/lpkt.py \
...
} >> /home/xiongzj/myProjects/KT/dlkt/example/results/lpkt_our_setting_xes3g5m_save.txt