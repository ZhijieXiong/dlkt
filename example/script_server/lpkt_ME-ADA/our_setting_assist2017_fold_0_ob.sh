        ...
        do
          ...
          do
            ...
            do
              ...
              CUDA_VISIBLE_DEVICES=1 python /home/xiongzj/myProjects/KT/dlkt/example/train/lpkt_max_entropy_aug.py \
...
#} >> /home/xiongzj/myProjects/KT/dlkt/example/results/lpkt_ME-ADA_our_setting_assist2017_fold_0_ob.txt