  ...
  do
    ...
    do
      ...
      do
        for gamma in ${gammas}
        do
          echo -e "weight_adv_pred_loss: ${weight_adv_pred_loss}, adv_learning_rate: ${adv_learning_rate}, eta: ${eta}, gamma: ${gamma}"
...
} >> /home/xiongzj/myProjects/KT/dlkt/example/results/qdkt_ME-ADA_our_setting_bridge2algebra2006_fold_0_ob.txt