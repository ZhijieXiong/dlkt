python /Users/dream/Desktop/code/projects/dlkt/example/train/atkt.py \
  ...
  --grad_clipped 10.0 --num_concept 53 --dim_concept 64 --dim_correct 64 --dim_latent 256 \
  --dim_attention 64 --dropout 0.1 --epsilon 15 --beta 2 --save_model False \
  --debug_mode False --seed 0 