python F:/code/myProjects/dlkt/example/train/qdkt_output_enhance.py \
  ...
  --num_predict_layer 3 --dim_predict_mid 128 --activate_type relu --enhance_method 2 --weight_enhance_loss1 1 \
  --num_min_question4diff 100 --hard_acc 0.4 --easy_acc 0.8 --weight_enhance_loss2 1 --enhance_method2_update_few_shot True \
  --num_few_shot 5 --use_LLM_emb4question False --use_LLM_emb4concept False --train_LLM_emb True --save_model False \
  --seed 0 