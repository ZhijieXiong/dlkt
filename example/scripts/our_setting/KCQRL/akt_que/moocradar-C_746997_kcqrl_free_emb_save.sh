...

{
  ...
  do
    ...
    python /ghome/xiongzj/code/dlkt-release/example/train/akt_que.py \
      ...
      --num_question 550 --que_emb_file_name "qid2content_sol_avg_emb.json" --frozen_que_emb False \
      --dim_model 64 --key_query_same True --num_head 4 --num_block 1 --dim_ff 256 --dim_final_fc 256 --dropout 0.2 \
...
} >> /ghome/xiongzj/code/dlkt-release/example/result_cluster/our_setting_akt_que_kcqrl_free_emb_moocradar-C_746997_save.txt