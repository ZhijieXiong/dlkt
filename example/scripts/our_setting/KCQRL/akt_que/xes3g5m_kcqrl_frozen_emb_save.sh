...

{
  ...
  do
    ...
    python /ghome/xiongzj/code/dlkt-release/example/train/akt_que.py \
      ...
      --num_question 7652 --que_emb_file_name "qid2content_sol_avg_emb.json" --frozen_que_emb True \
...
} >> /ghome/xiongzj/code/dlkt-release/example/result_cluster/our_setting_akt_que_kcqrl_frozen_emb_xes3g5m_save.txt