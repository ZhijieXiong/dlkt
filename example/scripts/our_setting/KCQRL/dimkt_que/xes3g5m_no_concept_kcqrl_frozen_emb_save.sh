...

{
  ...
  do
    ...
    python /ghome/xiongzj/code/dlkt-release/example/train/dimkt_que.py \
      ...
      --use_concept False --que_emb_file_name "qid2content_sol_avg_emb.json" --frozen_que_emb True \
...
} >> /ghome/xiongzj/code/dlkt-release/example/result_cluster/our_setting_dimkt_que_no_concept_kcqrl_frozen_emb_xes3g5m_save.txt