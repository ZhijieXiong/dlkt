...

{
  ...
  do
    ...
    python /ghome/xiongzj/code/dlkt-release/example/train/dkt.py \
      ...
      --use_concept False --num_concept 265 --num_question 550 \
...
} >> /ghome/xiongzj/code/dlkt-release/example/result_cluster/our_setting_dkt_use_que_moocradar-C_746997_save.txt