...

{
  ...
  do
    ...
    python /ghome/xiongzj/code/dlkt-release/example/train/dkvmn_que.py \
      ...
      --num_question 550 --que_emb_file_name "qid2content_emb.json" --frozen_que_emb False \
      --dim_key 32 --dim_value 32 --dropout 0.1 \
      --save_model True --debug_mode False --use_cpu False --seed 0 --trace_epoch True
  done
} >> /ghome/xiongzj/code/dlkt-release/example/result_cluster/our_setting_dkvmn_que_official_emb_free_emb_moocradar-C_746997_save.txt