...

{
  ...
  do
    ...
    python /ghome/xiongzj/code/dlkt-release/example/train/dkvmn_que.py \
      ...
      --num_question 7652 --que_emb_file_name "qid2content_CL-no-cluster_only-original-KC.json" --frozen_que_emb False \
      --dim_key 64 --dim_value 32 --dropout 0.2 \
      --save_model True --debug_mode False --use_cpu False --seed 0 --trace_epoch True
  done
} >> /ghome/xiongzj/code/dlkt-release/example/result_cluster/our_setting_dkvmn_que_kcqrl_CL-no-cluster_only-original-KC_free_emb_xes3g5m_save.txt