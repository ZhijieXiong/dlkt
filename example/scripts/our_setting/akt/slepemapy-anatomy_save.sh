...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/akt.py \
      ...
      --dim_model 256 --key_query_same True --num_head 8 --num_block 2 --dim_ff 256 --dim_final_fc 512 --dropout 0.2 \
...
} >> F:/code/myProjects/dlkt/example/result_local/akt_our_setting_new_slepemapy-anatomy_save.txt