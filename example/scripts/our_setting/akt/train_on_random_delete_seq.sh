...
#  done
#
#} >> F:/code/myProjects/dlkt/example/result_local/akt_random_delete_seq_our_setting_new_assist2009_save.txt
...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/akt.py \
      ...
      --train_batch_size 24 --evaluate_batch_size 64 \
      --enable_clip_grad True --grad_clipped 10.0 \
...
} >> F:/code/myProjects/dlkt/example/result_local/akt_random_delete_seq_our_setting_new_assist2012_save.txt
...
} >> F:/code/myProjects/dlkt/example/result_local/akt_random_delete_seq_our_setting_new_assist2017_save.txt
...
} >> F:/code/myProjects/dlkt/example/result_local/akt_random_delete_seq_our_setting_new_ednet-kt1_save.txt
...
#  done
#
#} >> F:/code/myProjects/dlkt/example/result_local/akt_random_delete_seq_our_setting_new_statics2011_save.txt