...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/akt_core.py \
      ...
      --num_block 1 --num_head 8 --dropout 0.2 --fusion_mode "rubin" --weight_rasch_loss 0.00001 \
      --save_model True --debug_mode False --use_cpu False --seed 0 --trace_epoch True
  done

} >> F:/code/myProjects/dlkt/example/result_local/akt-core_our_setting_new_assist2009_save.txt