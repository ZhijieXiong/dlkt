...
dataset_names=("assist2009" "assist2012" "assist2017" "ednet-kt1" "statics2011" "slepemapy" "junyi2015" "edi2020-task34" "edi2020-task1")
folds=(0 1 2 3 4)
...

{
  ...
  do
    ...
    do
      echo -e "------------------------------------fold_${fold}-----------------------------------------"
      python F:/code/myProjects/dlkt/example/data_analysis/biased_analysis.py \
        --data_path "F:/code/myProjects/dlkt/lab/settings/${setting_name}/${dataset_name}_train_fold_${fold}_unbiased_20.txt"
      echo -e "------------------------------------------------------------------------------------------\n"
    done
  done
} >> F:/code/myProjects/dlkt/example/result_local/unbiased_train_dataset_bias_analysis_result.txt