...
dataset_names=("assist2012" "assist2017" "ednet-kt1")
...

{
  ...
  do
    ...
    do
      echo -e "------------------------------------fold_${fold}-----------------------------------------"
      python F:/code/myProjects/dlkt/example/data_analysis/biased_analysis.py \
        --data_path "F:/code/myProjects/dlkt/lab/settings/${setting_name}/${dataset_name}_train_fold_${fold}_random_delete_seq.txt"
      echo -e "------------------------------------------------------------------------------------------\n"
    done
  done
} >> F:/code/myProjects/dlkt/example/result_local/random_delete_seq_train_dataset_bias_analysis_result.txt
...
#      echo -e "------------------------------------fold_${fold}-----------------------------------------"
#      python F:/code/myProjects/dlkt/example/data_analysis/biased_analysis.py \
#        --data_path "F:/code/myProjects/dlkt/lab/settings/${setting_name}/${dataset_name}_train_fold_${fold}_enlarge_biased_by_delete_seq.txt"
#      echo -e "------------------------------------------------------------------------------------------\n"
#    done
#  done
#} >> F:/code/myProjects/dlkt/example/result_local/enlarge_biased_train_dataset_by_delete_seq_bias_analysis_result.txt