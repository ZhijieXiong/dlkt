...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/dimkt.py \
      ...
      --num_min_question 20 --num_min_concept 30 --num_concept 282 --num_question 27613 \
...
} >> F:/code/myProjects/dlkt/example/result_local/dimkt_our_setting_new_edi2020-task1_save.txt