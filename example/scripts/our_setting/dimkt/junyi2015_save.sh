...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/dimkt.py \
      ...
      --num_min_question 30 --num_min_concept 30 --num_concept 40 --num_question 817 \
...
} >> F:/code/myProjects/dlkt/example/result_local/dimkt_our_setting_new_junyi2015_save.txt