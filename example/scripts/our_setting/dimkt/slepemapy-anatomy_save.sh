...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/dimkt.py \
      ...
      --num_min_question 150 --num_min_concept 30 --num_concept 246 --num_question 5730 \
...
} >> F:/code/myProjects/dlkt/example/result_local/dimkt_our_setting_new_slepemapy-anatomy_save.txt