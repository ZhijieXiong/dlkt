...

{
  ...
  do
    ...
    python /ghome/xiongzj/code/dlkt/example/train/dkvmn.py \
      ...
      --use_concept True --num_concept 188 --num_question 11858 --dim_key 64 --dim_value 64 --dropout 0.2 \
      --save_model True --debug_mode False --use_cpu False --seed 0 --trace_epoch True
  done
} >> /ghome/xiongzj/code/dlkt/example/result_cluster/dkvmn_our_setting_new_ednet-kt1_save.txt