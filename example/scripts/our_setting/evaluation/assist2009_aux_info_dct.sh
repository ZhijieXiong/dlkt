...
do
  ...
  python F:/code/myProjects/dlkt/example/evaluate.py \
    ...
    --train_statics_common_path "F:\code\myProjects\dlkt\lab\settings\our_setting_new\assist2009_train_fold_0_statics_common.json" \
    --train_statics_special_path "F:\code\myProjects\dlkt\lab\settings\our_setting_new\assist2009_train_fold_0_statics_special.json" \
    ...
    --transfer_head2zero False --is_dimkt False  --is_dct True
done
