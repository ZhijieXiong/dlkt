...
do
  ...
  python F:/code/myProjects/dlkt/example/evaluate.py \
    ...
    --transfer_head2zero False --is_dct False \
    --is_dimkt True --num_question_diff 100 --num_concept_diff 100 \
    --train_diff_file_path "F:\code\myProjects\dlkt\lab\settings\our_setting\assist2009_train_fold_0_dimkt_diff.json"
done
