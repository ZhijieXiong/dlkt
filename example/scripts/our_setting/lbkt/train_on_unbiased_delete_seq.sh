...
} >> F:/code/myProjects/dlkt/example/result_local/lbkt_unbiased_by_delete_seq_our_setting_new_assist2009_save.txt
...
} >> F:/code/myProjects/dlkt/example/result_local/lbkt_unbiased_by_delete_seq_our_setting_new_assist2012_save.txt
...
} >> F:/code/myProjects/dlkt/example/result_local/lbkt_unbiased_by_delete_seq_our_setting_new_assist2017_save.txt