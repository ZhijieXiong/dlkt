...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/lpkt.py \
      ...
      --train_batch_size 16 --evaluate_batch_size 64 \
      --enable_clip_grad False --grad_clipped 10.0 \
      --num_concept 282 --num_question 27613 \
      --ablation_set 1 --dim_e 128 --dim_k 128 --dim_correct 50 --dropout 0.1 \
      --save_model True --debug_mode False --use_cpu False --seed 0 --trace_epoch True
  done
} >> F:/code/myProjects/dlkt/example/result_local/lpkt_our_setting_new_edi2020-task1_save.txt