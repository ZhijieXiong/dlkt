...
} >> F:/code/myProjects/dlkt/example/result_local/lpkt_random_delete_seq_our_setting_new_assist2012_save.txt
...
} >> F:/code/myProjects/dlkt/example/result_local/lpkt_random_delete_seq_our_setting_new_assist2017_save.txt
...
} >> F:/code/myProjects/dlkt/example/result_local/lpkt_random_delete_seq_our_setting_new_ednet-kt1_save.txt
