...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/lpkt.py \
      ...
      --train_batch_size 16 --evaluate_batch_size 256 \
      --enable_clip_grad False --grad_clipped 10.0 \
      --num_concept 265 --num_question 53091 \
      --ablation_set 0 --dim_e 128 --dim_k 128 --dim_correct 50 --dropout 0.2 \
      --save_model True --debug_mode False --use_cpu False --seed 0
  done
} >> F:/code/myProjects/dlkt/example/result_local/lpkt_unbiased_by_delete_seq_our_setting_new_assist2012_save.txt
...
} >> F:/code/myProjects/dlkt/example/result_local/lpkt_unbiased_by_delete_seq_our_setting_new_assist2017_save.txt
...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/lpkt.py \
      ...
      --ablation_set 0 --dim_e 64 --dim_k 64 --dim_correct 50 --dropout 0.4 \
      --save_model True --debug_mode False --use_cpu False --seed 0
  done
} >> F:/code/myProjects/dlkt/example/result_local/lpkt_unbiased_by_delete_seq_our_setting_new_ednet-kt1_save.txt
