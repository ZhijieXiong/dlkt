...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/dkvmn.py \
      ...
      --use_concept False --num_concept 53 --num_question 948 --dim_key 32 --dim_value 64 --dropout 0.1 \
      --save_model True --debug_mode False --use_cpu False --seed 0
  done
} >> F:/code/myProjects/dlkt/example/result_local/dkvmn_que_pykt_question_setting_edi2020-task34_save.txt
...
} >> F:/code/myProjects/dlkt/example/result_local/dkvmn_que_pykt_question_setting_statics2011_save.txt