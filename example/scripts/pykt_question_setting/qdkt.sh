...
} >> F:/code/myProjects/dlkt/example/result_local/qdkt_pykt_question_setting_algebra2005_save.txt
...
} >> F:/code/myProjects/dlkt/example/result_local/qdkt_pykt_question_setting_assist2009_save.txt
...
} >> F:/code/myProjects/dlkt/example/result_local/qdkt_pykt_question_setting_bridge2algebra2006_save.txt
...
} >> F:/code/myProjects/dlkt/example/result_local/qdkt_pykt_question_setting_edi2020-task34_save.txt
...
} >> F:/code/myProjects/dlkt/example/result_local/qdkt_pykt_question_setting_statics2011_save.txt
...
} >> F:/code/myProjects/dlkt/example/result_local/qdkt_pykt_question_setting_xes3g5m_save.txt