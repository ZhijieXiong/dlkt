...
} >> F:/code/myProjects/dlkt/example/result_local/qikt_pykt_question_setting_assist2009_save.txt
...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/qikt.py \
      ...
      --dim_emb 256 --rnn_type "gru" --num_rnn_layer 1 --dropout 0.3 --num_mlp_layer 1 \
      --lambda_q_all 1 --lambda_c_next 1 --lambda_c_all 1 --use_irt True \
      --weight_predict_q_all_loss 2 --weight_predict_q_next_loss 1 \
      --weight_predict_c_all_loss 0.5 --weight_predict_c_next_loss 2 \
      --save_model True --debug_mode False --use_cpu False --seed 0
  done
} >> F:/code/myProjects/dlkt/example/result_local/qikt_pykt_question_setting_edi2020-task34_save.txt
...
} >> F:/code/myProjects/dlkt/example/result_local/qikt_pykt_question_setting_statics2011_save.txt