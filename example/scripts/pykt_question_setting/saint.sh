...

{
  ...
  do
    echo -e "fold: ${fold}"
    python F:/code/myProjects/dlkt/example/train/saint.py \
      ...
      --dim_emb 64 --num_block 2 --num_attn_head 4 --dropout 0.5 --seq_len 200 \
      --save_model True --debug_mode False --use_cpu False --seed 0
  done
} >> F:/code/myProjects/dlkt/example/result_local/saint_pykt_question_setting_edi2020-task34_save.txt
...

{
  ...
  do
    ...
    python F:/code/myProjects/dlkt/example/train/saint.py \
      ...
      --dim_emb 64 --num_block 4 --num_attn_head 4 --dropout 0.5 --seq_len 200 \
      --save_model True --debug_mode False --use_cpu False --seed 0
  done
} >> F:/code/myProjects/dlkt/example/result_local/saint_pykt_question_setting_statics2011_save.txt