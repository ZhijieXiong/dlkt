...
from config.akt_config import akt_core_config

from lib.util.parse import str2bool
from lib.util.set_up import set_seed
from lib.dataset.KTDataset import KTDataset
from lib.model.AKT_CORE import AKT_CORE
from lib.trainer.KnowledgeTracingTrainer import KnowledgeTracingTrainer


# 必须同时有question和concept的id信息
if __name__ == "__main__":
    ...
    global_params, global_objects = akt_core_config(params)
    ...
    model = AKT_CORE(global_params, global_objects).to(global_params["device"])
