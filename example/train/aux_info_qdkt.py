...
from config.aux_info_qdkt_config import aux_info_qdkt_config

from lib.util.parse import str2bool
from lib.util.set_up import set_seed
from lib.dataset.KTDataset import KTDataset
from lib.model.AuxInfoQDKT import AuxInfoQDKT
...
if __name__ == "__main__":
    ...
    # 数据集相关
    parser.add_argument("--setting_name", type=str, default="our_setting_w_cold_start_wo_long_tail")
    ...
    global_params, global_objects = aux_info_qdkt_config(params)
    ...
    model = AuxInfoQDKT(global_params, global_objects).to(global_params["device"])
