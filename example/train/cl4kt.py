...
from config.cl4kt_config import cl4kt_config

from lib.util.parse import str2bool
from lib.util.set_up import set_seed
from lib.dataset.KTDataset import KTDataset
from lib.dataset.KTDataset4Aug import KTDataset4Aug
from lib.model.CL4KT import CL4KT
...
if __name__ == "__main__":
    ...
    parser.add_argument("--hard_neg_weight", type=float, default=1)
    # 其它
    ...
    global_params, global_objects = cl4kt_config(params)
    ...
    global_objects["models"] = {}
    model = CL4KT(global_params, global_objects).to(global_params["device"])
