...
if __name__ == "__main__":
    ...
    # 数据集相关
    parser.add_argument("--setting_name", type=str, default="dTransformer_setting")
    ...
    # 优化器相关参数选择
    parser.add_argument("--optimizer_type", type=str, default="adamW", choices=("adam", "sgd", "adamW"))
