...
from config.dct_config import dct_mex_entropy_aug_config
...
if __name__ == "__main__":
    ...
    parser.add_argument("--epoch_early_stop", type=int, default=15)
    ...
    global_params, global_objects = dct_mex_entropy_aug_config(params)
