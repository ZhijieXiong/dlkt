...
from config.dimkt_config import dimkt_core_config

from lib.util.parse import str2bool
from lib.util.set_up import set_seed
from lib.dataset.KTDataset import KTDataset
from lib.model.DIMKT_CORE import DIMKT_CORE
...
if __name__ == "__main__":
    ...
    global_params, global_objects = dimkt_core_config(params)
    ...
    model = DIMKT_CORE(global_params, global_objects).to(global_params["device"])
