...
from config.dimkt_que_config import dimkt_que_config

from lib.util.parse import str2bool
from lib.util.set_up import set_seed
from lib.dataset.KTDataset import KTDataset
from lib.model.DIMKT_QUE import DIMKT_QUE
...
if __name__ == "__main__":
    ...
    global_params, global_objects = dimkt_que_config(params)
    ...
    model = DIMKT_QUE(global_params, global_objects).to(global_params["device"])
