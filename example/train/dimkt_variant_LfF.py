...
from config.dimkt_config import dimkt_variant_LfF_config
...
if __name__ == "__main__":
    ...
    global_params, global_objects = dimkt_variant_LfF_config(params)
    ...
    model_biased = DIMKT_VARIANT(global_params, global_objects).to(global_params["device"])
    model_de_biased = DIMKT_VARIANT(global_params, global_objects).to(global_params["device"])
