...
from config.dkvmn_que_config import dkvmn_que_config

from lib.util.parse import str2bool
from lib.util.set_up import set_seed
from lib.dataset.KTDataset import KTDataset
from lib.model.DKVMN_QUE import DKVMN_QUE
...
if __name__ == "__main__":
    ...
    parser.add_argument("--frozen_que_emb", type=str2bool, default=False,
                        help="是否固定预训练的question emb")
    parser.add_argument("--dim_key", type=int, default=20)
    parser.add_argument("--dim_value", type=int, default=20)
    ...
    global_params, global_objects = dkvmn_que_config(params)
    ...
    model = DKVMN_QUE(global_params, global_objects).to(global_params["device"])
