...
from config.lpkt_config import lpkt_max_entropy_adv_aug_config
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_question", type=int, default=2083)
    ...
    global_params, global_objects = lpkt_max_entropy_adv_aug_config(params)
