...
from config.mikt_config import mikt_config

from lib.util.parse import str2bool
from lib.util.set_up import set_seed
from lib.dataset.KTDataset import KTDataset
from lib.model.MIKT import MIKT
...
if __name__ == "__main__":
    ...
    global_params, global_objects = mikt_config(params)
    ...
    model = MIKT(global_params, global_objects).to(global_params["device"])
