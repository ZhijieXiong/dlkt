...
from config.qdkt_config import qdkt_cluster_cl_config
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_file_name", type=str, default="edi2020-task34_test_fold_0.txt")
    # 优化器相关参数选择
    ...
    parser.add_argument("--aug_order", type=str, default="['mask', 'replace', 'permute', 'crop']",
