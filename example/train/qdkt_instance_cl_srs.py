...
from config.qdkt_config import qdkt_instance_cl_srs_config

from lib.util.parse import str2bool
from lib.util.set_up import set_seed
from lib.dataset.KTDataset import KTDataset
from lib.dataset.SRSDataset4KT_UseRandomAug import SRSDataset4KT_UseRandomAug
from lib.model.qDKT import qDKT
from lib.trainer.InstanceCLTrainerSRS import InstanceCLTrainerSRS
...
if __name__ == "__main__":
    ...
    parser.add_argument("--debug_mode", type=str2bool, default=False, help="if True, set_detect_anomaly")
    parser.add_argument("--seed", type=int, default=0)

    args = parser.parse_args()
    params = vars(args)
    set_seed(params["seed"])
    global_params, global_objects = qdkt_instance_cl_srs_config(params)
    ...
    dataset_train = SRSDataset4KT_UseRandomAug(train_params, global_objects)
    ...
    trainer = InstanceCLTrainerSRS(global_params, global_objects)
    trainer.train()
