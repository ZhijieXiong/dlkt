...
from config.sakt_config import sakt_config

from lib.util.parse import str2bool
from lib.util.set_up import set_seed
from lib.dataset.KTDataset import KTDataset
from lib.model.SAKT import SAKT
...
if __name__ == "__main__":
    ...
    global_params, global_objects = sakt_config(params)
    ...
    model = SAKT(global_params, global_objects).to(global_params["device"])
