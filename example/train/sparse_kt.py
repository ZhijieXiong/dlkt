...
from config.sparse_kt_config import sparse_kt_config

from lib.util.parse import str2bool
from lib.util.set_up import set_seed
from lib.dataset.KTDataset import KTDataset
from lib.model.SparseKT import SparseKT
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dim_final_fc2", type=int, default=256)
    parser.add_argument("--dropout", type=float, default=0.1)
    parser.add_argument("--kq_same", type=str2bool, default=True)
    parser.add_argument("--separate_qa", type=str2bool, default=False)
    parser.add_argument("--seq_len", type=int, default=200)
    parser.add_argument("--k_index", type=int, default=5)
    parser.add_argument("--use_akt_rasch", type=str2bool, default=True)
    # 其它
    ...
    global_params, global_objects = sparse_kt_config(params)
    ...
    global_objects["models"] = {}
    model = SparseKT(global_params, global_objects).to(global_params["device"])
