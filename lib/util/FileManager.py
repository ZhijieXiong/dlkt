...
class FileManager:
    dataset_raw_path_in_lab = {
        ...
        "slepemapy-anatomy": "lab/dataset_raw/slepemapy-anatomy/answers.csv",
    ...
    data_preprocessed_dir_in_lab = {
        ...
        "slepemapy-anatomy": "lab/dataset_preprocessed/slepemapy-anatomy",
    ...
    def create_dirs(self):
        ...
        all_dirs = [
            ...
            os.path.join(self.root_dir, "lab", "dataset_raw", "slepemapy-anatomy"),
            ...
            os.path.join(self.root_dir, "lab", "dataset_preprocessed", "slepemapy-anatomy"),
