...
if __name__ == "__main__":
    ...
    parser.add_argument("--file_path", type=str,
                        default=r"F:\code\myProjects\dlkt\example\result_local\our_setting_new\aux-info-dct-no-concept-emb-irt-not-share\mask-no-pretrain-no-aux-loss\ednet-kt1_save.txt")
