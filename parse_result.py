...
if __name__ == "__main__":
    ...
    parser.add_argument("--file_path", type=str, default=r"F:\code\myProjects\dlkt\example\result_local\lpkt+_irt_share_baseline\our_setting_statics2011_save.txt")
