...
if __name__ == "__main__":
    ...
    parser.add_argument("--file_path", type=str, default=r"F:\code\myProjects\dlkt\example\result_local\lpkt_plus_v2_our_setting_ood_slepemapy_split_0_save_ob.txt")
