...
if __name__ == "__main__":
    ...
    parser.add_argument("--file_path", type=str, default=r"F:\code\myProjects\dlkt\example\result_local\dct_irt_new_not_share_baseline_our_setting_xes3g5m_save.txt")
