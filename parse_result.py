...
if __name__ == "__main__":
    ...
    parser.add_argument("--file_path", type=str,
                        default=r"F:\code\myProjects\dlkt\example\result_local\our_setting_new\aux_info_dct\penalty_weight2\auxInfoDct-penalty-loss_our_setting_new_assist2009_save.txt")
