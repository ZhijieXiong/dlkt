python F:/code/myProjects/dlkt/example/train/lpkt.py \
  --setting_name "our_setting" --dataset_name "ednet-kt1" --data_type "only_question" \
  --train_file_name "ednet-kt1_train_fold_4.txt" --valid_file_name "ednet-kt1_valid_fold_4.txt" --test_file_name "ednet-kt1_test_fold_4.txt" \
