python /Users/dream/Desktop/code/projects/dlkt/example/train/qdkt_dro.py \
  --setting_name "our_setting_ood_by_school" --dataset_name "SLP-phy" --data_type "single_concept" \
  --train_file_name "SLP-phy_train_split_2.txt" --valid_file_name "SLP-phy_valid_iid_split_2.txt" --test_file_name "SLP-phy_test_ood_split_2.txt" \
  ...
  --use_dro True --beta 5.0 --alpha 0.001 --max_seq_len 200 \
